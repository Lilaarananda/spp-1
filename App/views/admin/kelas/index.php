            ...
            <tbody class="table-group-divider">
                <?php foreach ($data["kelas"] as $kelas) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= BASE_URL ?>admin/editKelas/<?= $kelas["id_kelas"] ?>" class="badge-warning badge-pill px-2.5 mr-2">edit</a>
                            <a href="<?= BASE_URL ?>admin/hapusKelas/<?= $kelas["id_kelas"] ?>" class="badge-danger badge-pill px-2.5" onclick="return confirm('yakin ingin menghapus data?')">delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer d-sm-flex align-items-center justify-content-between">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" href="<?= BASE_URL ?>admin/kelas">Batal</button>
